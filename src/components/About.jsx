    ...
    return(
        ...
        <div className="about-container" id="about-section"> 
            ...
            <div className="flex">
                ...
                <div className="bio">
                    <p><span id="bio-">Sinesipho Siyaka</span> is a talented and dynamic Self-taught Software Developer. She is passionate about building solutions using Full-stack development and AI Systems to solve society's problems.
