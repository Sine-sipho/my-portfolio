...
export default function Hero(){
    ...
    return(
        ...
        <div className="content">
            <h1>Hi, I'm Sinesipho. I'm an aspiring <span> Software Developer.</span></h1>
            <div className="pull-down-arrow">
                <p>Press to see my work</p>
                <span><Link to="projects-section" smooth="true" duration="500"><ArrowDown color="burlywood" size={35}/></Link></span>
            </div>
        </div>
        </div>
        </>
